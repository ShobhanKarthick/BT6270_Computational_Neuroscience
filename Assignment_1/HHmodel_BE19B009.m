...
j = 1; peakNum = [];
currMax = 0.75;
thresholdVoltage = 7.5;

 
% for curr=0:0.001:currMax
v=-64.9964;
m=0.0530;
h=0.5960;
n=0.3177;
...
%     peaks = findpeaks(vhist);
%     peakNum(j) = length(peaks(peaks > thresholdVoltage));
%     j = j + 1;
% end
...
% figure(4)
% curr = 0:0.001:currMax;
% plot(curr,peakNum, 'LineWidth',2)
% title('Number of peaks Vs Iext')